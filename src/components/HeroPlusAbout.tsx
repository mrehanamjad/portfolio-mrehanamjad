    ...
    >
      <Container>
        ...
        <div
          ...
          className="absolute  overflow-hidden bg-[#f5f4f7e3] text-neutral-800 top-0 left-0 h-full w-full flex flex-col gap-4 justify-center items-center "
        >
          <div className="h-full relative top-0  flex justify-center items-center flex-col gap-8 md:gap-20">
          {/* Green glowing background */}
          <div
            id="green-glow"
            className="absolute top-1/2 left-1/2 w-[90rem] h-[70rem] -translate-x-1/2 -translate-y-1/2 rounded-full blur-[180px] z-0"
            style={{
              background:
          ...
          ></div>
            ...
            <p
              id="about-txt"
              className="aboutme-text text-center hidden  z-[1] text-balance text-neutral-700 text-xl md:text-2xl lg:text-3xl font-semibold leading-relaxed"
            >
