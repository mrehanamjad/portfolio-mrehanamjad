...
export function HeroSection() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] px-6 text-center">
      ...
      <TypeWrite texts={["Full Stack Developer", "AI Developer","Software Engineer"]} />
      ...
      >
        I create modern web applications and intelligent AI solutions that solve real-world problems.
      </motion.p>
