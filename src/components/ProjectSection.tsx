...
//     // Final resting rotation per card (shared by entrance + pin timeline)
//     const restRotate = (i: number) => (isMobile ? 0 : i !== 0 ? i + 2 : 0);

//     // ---------------------------------------------------------------
//     // 1) INITIAL STATE — scatter cards off-screen before they're dealt in
//     // ---------------------------------------------------------------
//     gsap.set(cardElements, {
//       x: () => gsap.utils.random(-vh * 0.6, vh * 0.6),
//       y: () => -vh * gsap.utils.random(0.8, 1.4),
...
//     // ---------------------------------------------------------------
//     // 2) DEAL-IN ENTRANCE — plays once when the section first scrolls into view
//     // ---------------------------------------------------------------
...
//     dealTl.to(cardElements, {
//       x: 0,
//       y: 0,
//       rotate: (i) => restRotate(i),
//       opacity: 1,
//       duration: 0.9,
//       ease: "power3.out",
//       stagger: {
//         each: 0.14,
//         from: "end", // bottom-of-deck card (last in array) lands first, top card lands last
//       },
//     });

//     // ---------------------------------------------------------------
//     // 3) PIN + SCRUB STACKING TIMELINE — unchanged, starts from the dealt resting position
//     // ---------------------------------------------------------------
//     const mainTl = gsap.timeline({
//       scrollTrigger: {
//         trigger: cardsRef.current,
...
//                   }}
//                 >
//                   {/* Scale-only wrapper — this shrinks for stack depth */}
//                   <div className="card-scale-wrapper w-full h-full flex flex-col">
//                     {/* Terminal-style chrome bar */}
//                     <div className="flex items-center justify-between px-4 md:px-5 h-11 border-b border-white/[0.06] bg-[#16181D] shrink-0">
//                       <div className="flex items-center gap-3">
...
//                     {/* Body */}
//                     <div className="flex-1 flex max-md:flex-col md:flex-row gap-4 md:gap-6 p-4 md:p-6 min-h-0">
//                       {/* Text block — counter-scaled to stay crisp */}
//                       <div className="card-text-block flex flex-col md:w-[38%] h-full justify-between min-h-0">
//                         <div className="flex flex-col gap-4 min-h-0">
//                           <h4 className="font-bold text-2xl md:text-3xl text-[#F5F3EE] tracking-tight leading-tight">
//                             {card.title}
